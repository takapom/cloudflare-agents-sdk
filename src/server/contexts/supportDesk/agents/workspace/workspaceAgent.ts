...
import { structuredTenantReportSchema } from "@/server/contexts/supportDesk/agents/workspace/tools/ticketSchemas";
import { supportDeskSystemPrompt } from "@/server/contexts/supportDesk/agents/workspace/prompts";
import { readonlyToolNames, isMutatingTool } from "@/server/contexts/supportDesk/agents/workspace/toolPolicy";
import { createWorkspaceTools } from "@/server/contexts/supportDesk/agents/workspace/tools";
import {
  createSupportDeskContext,
  type SqlQuery
} from "@/server/contexts/supportDesk/supportDeskContext";
import { replyDraftUserPrompt } from "@/server/contexts/supportDesk/agents/replyDraft/prompts";
